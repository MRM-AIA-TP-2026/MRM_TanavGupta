...
class Mass {
  public:
    ...
    string CompareWeight( Mass p){
      if(TotalWeight()>p.TotalWeight()) return "The first object is heavier.";
      else if(TotalWeight()<p.TotalWeight()) return "The second object is heavier.";
